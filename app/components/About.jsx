...
<main className='px-5'>
    <div>
        ...
        <div className='md:mt-10 flex flex-col items-center justify-center md:gap-1'>
                <div className='flex gap-3 items-center md:md:justify-center    w-full  rounded-md py-3 text-center' onClick={switchToggleOne} >
                    {toggleOne ? 
                    <h3 className=' cursor-pointer text-accent font-medium text-lg md:text-xl  ' >Background and Training </h3>
                    : <h3 className=' cursor-pointer md:hover:text-accent font-normal text-lg md:text-xl  ' >Background and Training </h3>}
                ...
                <div className='flex gap-3 items-center md:justify-center   w-full rounded-md py-3  text-center' onClick={switchToggleTwo}>
                    {toggleTwo ? <h3 className=' cursor-pointer text-accent font-medium text-lg md:text-xl '>Teaching Style</h3> 
                    : <h3 className=' cursor-pointer md:hover:text-accent font-normal text-lg md:text-xl '>Teaching Style</h3>}
                ...
                <div className='flex gap-3 items-center md:justify-center   w-full rounded-md py-3  text-center' onClick={switchToggleThree}>
                    {toggleThree ? <h3 className=' cursor-pointer text-accent font-medium text-lg md:text-xl '>Personal Philosophy</h3> 
                    : <h3 className=' cursor-pointer md:hover:text-accent font-normal text-lg md:text-xl '>Personal Philosophy</h3>}
                ...
                <div className='flex gap-3 items-center md:justify-center  w-full  rounded-md py-3 text-center' onClick={switchToggleFour}>
                    {toggleFour ? <h3 className=' cursor-pointer text-accent font-medium text-lg md:text-xl '>Community & Connection</h3> 
                    : <h3 className=' cursor-pointer md:hover:text-accent font-normal text-lg md:text-xl '>Community & Connection</h3>}
