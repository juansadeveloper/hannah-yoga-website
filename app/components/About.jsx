...
<main className='px-5'>
    <div>
        <div id="about" className='bg-[#F0EDEA] px-5 mt-20 md:mt-40 scroll-mt-[130px] md:scroll-mt-[200px] text-center w-full max-w-[1080px] flex flex-col justify-center mx-auto p-5 md:p-10 bg-white/85  rounded-lg shadow-box  '>
        ...
        <div className='mt-10 flex flex-col items-center justify-center gap-3'>
                <div className='flex gap-3 items-center justify-center   cursor-pointer w-full  rounded-md py-3 text-center' onClick={switchToggleOne} >
                    {toggleOne ? 
                ...
                <div className='flex gap-3 items-center justify-center  cursor-pointer w-full rounded-md py-3  text-center' onClick={switchToggleTwo}>
                ...
                <div className='flex gap-3 items-center justify-center  cursor-pointer w-full rounded-md py-3  text-center' onClick={switchToggleThree}>
                ...
                <div className='flex gap-3 items-center justify-center cursor-pointer w-full  rounded-md py-3 text-center' onClick={switchToggleFour}>
