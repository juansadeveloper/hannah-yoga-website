...
function About() {
  ...
  return (
    <main id="about" className='mt-40 scroll-mt-[200px] text-center w-full max-w-[1080px] flex flex-col justify-center mx-auto p-10 bg-white/85 border-[1.5px] border-[#4a4036]/20  text-accent rounded  '>
        ...
        <h1 className='text-accent font-bold text-5xl mt-20 mb-20'>Who is Hannah?</h1>
        <p className='text-center text-lg'>Hannah is a dedicated and compassionate yoga teacher with over a decade of experience in guiding individuals on their yoga journey. Her teaching philosophy centers around the belief that yoga is for everyone, regardless of age, fitness level, or experience. Hannah&apos;s approach is holistic, combining physical postures, breathing techniques, and mindfulness practices to create a well-rounded and enriching yoga experience.</p>
        ...
        <div className='mt-20 flex flex-col items-start gap-3'>
            <div className='flex gap-3 items-center   cursor-pointer' onClick={switchToggleOne} >
                <h3 className='text-accent font-medium text-xl ' >Background and Training </h3>
            ...
            <p className={toggleThree ? "text-justify" : "text-justify hidden"}>Hannah believes that yoga is more than just a physical practice; it is a journey of     self-discovery and personal growth. She is passionate about helping her students find balance, inner peace, and a deeper    connection to themselves. Her teachings encourage mindfulness, self-compassion, and a positive outlook on life.</p>

            <div className='flex gap-3 items-center cursor-pointer' onClick={switchToggleFour}>
                <h3 className='text-accent font-medium text-xl'>Community and Connection</h3>
                {toggleFour ? <IoIosArrowUp size={20} className='text-accent'/> : <IoIosArrowDown size={20} className='text-accent'/>}
            </div>
            <p className={toggleFour ? "text-justify" : "text-justify hidden"}>In addition to teaching, Hannah is committed to building a strong sense of community among her  students. She fosters an environment where everyone feels connected and supported, both on and off the mat. Through  workshops, retreats, and group classes, Hannah creates opportunities for her students to deepen their practice and form  lasting connections.</p>
        </div>
