...
function About() {
  ...
  return (
<main className='px-5'>
    <div id="about" className='bg-[#F0EDEA] px-5 mt-20 md:mt-40 scroll-mt-[130px] md:scroll-mt-[200px] text-center w-full max-w-[1080px] flex flex-col justify-center mx-auto p-5 md:p-10 bg-white/85   text-accent rounded-lg shadow-box  '>


        {/* <Image src={background} alt='background' fill={true} className='object-cover z-[-5]' /> */}
        <h1 className='text-accent font-bold text-3xl md:text-5xl mt-10 md:my-10'>About Hannah</h1>
