...
function Footer() {
  return (
    <main className='w-full max-md:pb-2 md:h-[350px] max-md:mt-28 z-10 relative bg-gradient-to-r from-[#ede3dd] via-[#faf7f5] to-[#ede3dd]'>
        ...
        <Link href="https://www.santiagopereira.net" target='blank'><h1 className='max-md:mx-auto max-md:mb-10 max-md:text-sm max-md:text-center max-md:mt-10 text-white/90 md:absolute md:right-0 md:mr-10 max-md:max-w-[210px] bg-black/20 px-3 py-1 rounded-md hover:text-white hover:bg-black/40  cursor-pointer'>Made by Infinite Studio</h1></Link>  
