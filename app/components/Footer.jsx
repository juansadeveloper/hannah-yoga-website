...
function Footer() {
  return (
    <main className='w-full h-[350px] z-10 relative'>
        ...
        <h1 className='text-white/90 absolute right-0 mr-10 bg-black/20 px-3 py-1 rounded-md hover:text-white hover:bg-black/40 cursor-pointer'>Made by SP Studio Design</h1>  
