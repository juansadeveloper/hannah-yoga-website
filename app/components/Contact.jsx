...
function Contact() {
  return (
    <main className='px-5'>
    <div id="contact" className='bg-[#F0EDEA] scroll-mt-[130px] md:scroll-mt-[200px] text-center w-full max-w-[1080px] flex flex-col items-center justify-center mx-auto p-10 pb-20 rounded-lg bg-white/85 shadow-box mt-20 md:mt-40 text-accent md:mb-[200px]'>
        ...
        <div className='flex flex-col items-start gap-5'>
            <div  className='flex justify-center items-center gap-5 hover:scale-[1.05]  cursor-pointer transition duration-300'>
                ...
                <p className='text-accent'>+353877622193</p>
            </div> 
            <div  className='flex justify-center items-center gap-5 hover:scale-[1.05]  cursor-pointer transition duration-300'>
                <MdOutlineEmail size={30} className='text-accent'/>
                <p className='text-accent'>eagnawithhannah@gmail.com</p>
            </div> 
