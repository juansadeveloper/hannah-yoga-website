    ...
    <main id="" className='mt-40 text-center w-full max-w-[1080px] flex flex-col items-center justify-center mx-auto p-5 bg-white/85 border-[1.5px] rounded'>
        ...
        <div className='flex flex-col items-center mt-20 text-accent px-5'>
            ...
            <div className='flex max-md:flex-col justify-center items-center gap-10 mb-20'>
                <div className='p-5 border rounded-full md:mt-20 w-full max-w-[300px min-h-[300px] flex flex-col items-center justify-start pt-20 bg-background/20'>
                ...
                <div className='p-5 border rounded-full md:mt-20  w-full max-w-[300px min-h-[300px] flex flex-col items-center justify-start pt-20 bg-background/40'>
                ...
                <div className='p-5 border rounded-full md:mt-20 w-full max-w-[300px min-h-[300px] flex flex-col items-center justify-start pt-20 bg-background/60'>
