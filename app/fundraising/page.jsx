    ...
    <main className='h-screen'>
        ...
        <div className='w-full h-[80px] bg-[#EADDD4] z-20 fixed top-0 flex items-center justify-center px-5'>
            <div className='flex items-center justify-between  w-full max-w-[1500px]'>
                <Link href="/"><div className='text-[#623810]/85 font-light text-[18px]  md:text-[24px] hover:scale-[1.05] transition duration-300'><span className='font-semibold text-[18px] md:text-[24px]'>EAGNA</span> WITH HANNAH</div></Link>
        ...
        <div className='min-h-[62vh] flex flex-col justify-center md:items-center max-md:mt-32 px-5 text-left'>
            ...
            <p className='mt-10 md:text-xl font-light'>At the moment we don´t have any upcoming event.</p>
            <p className='md:text-xl font-light'>For more information please contact Hannah.</p>
