...
function Page() {
  return (
    <main className='flex flex-col items-center justify-center'>
        ...
        <section className='min-h-screen flex flex-col justify-center items-center pt-5 px-5 mt-10'> 
            ...
            <div className='grid md:grid-cols-3 mx-auto my-auto h-full md:max-h-[700px] gap-5 max-w-[1240px] mt-5'>
                ...
                <div className='md:col-span-2 bg-[#f5f0ec] p-7 rounded-lg order-1'>
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-5'>
                        <p className='font-extralight bg-white/80 p-2 rounded'>“I wanted to thank you and express my appreciation to your yesterday&apos;s class. Your energy is really amazing. There is so much beauty that you can share -it is unbelievable. I sincerely wish you all the best in your new « trusting it -path» 🙏”</p>
                        <p className='font-extralight bg-white/80 p-2 rounded'>“I had such a great experience during our 1-1 yoga class! You brought so much care, compassion and fun to the session. Really enjoyed that it was tailored to my needs as it improved my practice loads giving me insight into how poses can be adjusted to suit my body.”</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section className='min-h-screen flex flex-col justify-center items-center max-md:px-5'>
            <h1 className='font-bold text-3xl mt-40  mb-10 max-md:text-center'>BOOK A YOGA CLASS TODAY</h1>
            <div className='w-full max-w-[1240px] flex flex-col md:flex-row items-center justify-center gap-10 py-7'>
                <div className='bg-[#f5f0ec] gap-5 p-7 rounded-lg flex flex-col items-center justify-center cursor-pointer transition duration-500 shadow hover:shadow-xl'>
                    <div>
                        <h1 className='font-bold text-3xl mb-10'>Individual Classes</h1>
                        <p className='max-w-[550px] mb-5 font-extralight '>Elevate your yoga journey with private classes tailored exclusively to you or your group. Receive individualized instruction and support from Hannah to deepen your practice and achieve your wellness goals.</p>
                    </div>
                    <Image src={photo4} alt='yoga-pic' className='object-cover w-full h-full max-w-[500px] max-h-[315px] max-md:h-[275px] rounded'/>
                    <button className=' mt-5 px-2 py-1 md:px-3 md:py-2 bg-white rounded text-[#623810]/85 border border-[#623810]/20 hover:border-[#623810]/50 font-medium transition duration-300 max-md:tracking-tight'>Book Individual Class</button>
                    {/* <button className='mt-5 ml-5 px-2 py-1 md:px-3 md:py-2 bg-transparent rounded text-[#623810]/85  hover:underline font-medium transition duration-300 max-md:tracking-tight'>Get more info</button> */}
                </div>
                <div className='bg-[#f5f0ec] gap-5 p-7 rounded-lg  cursor-pointer transition duration-500 shadow hover:shadow-xl'>
                    <div>
                        <h1 className='font-bold text-3xl mb-10'>Group Classes</h1>
                        <p className='max-w-[550px] mb-5 font-extralight '>With a variety of styles and levels, each class is designed to inspire and empower practitioners of all backgrounds. Whether you&apos;re a beginner or an experienced yogi, you&apos;ll find a class that meets your needs.</p>
                    </div>
        ...
        <section className='flex flex-col justify-center items-center px-5'>
                <div className='bg-white/80 border py-7 px-5 md:p-20 rounded w-full max-w-[300px]  md:max-w-[1240px] mt-20'>
                ...
                <div className='w-full max-w-[1240px] flex flex-col md:flex-row items-center justify-center gap-5 py-7'>
                    <div className='bg-[#f5f0ec] gap-5 p-7 rounded-lg flex-col items-center hover:scale-[1.03] cursor-pointer transition duration-500 shadow hover:shadow-xl'>
                        <div>
                    ...
                    <div className='bg-[#f5f0ec] gap-5 p-7 rounded-lg hover:scale-[1.03] cursor-pointer transition duration-500 shadow hover:shadow-xl'>
                        <div>
                ...
                <div className='text-[#623810]/85 text-xl font-base text-center mt-[150px] mb-20 bg-white/80 border py-5 px-5 md:p-10 rounded max-w-[1240px]'>
